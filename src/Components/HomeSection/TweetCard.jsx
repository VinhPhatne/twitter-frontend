...
import { createReTweet, createTweet, likeTweet } from "../../Store/Twit/Action";
    ...
    <React.Fragment>
      ...
      <div className="flex space-x-5">
        <Avatar
          ...
          alt="username"
          src="https://.pixabay.com/photo/2020/07/01/12/58/icon-5359553_960_720.png"
        />
        <div className="w-full">
          <div className="flex justify-between items-center">
            <div className="flex cursor-pointer items-center space-x-2">
              <span className="font-semiblod">{item?.user?.fullName}</span>
